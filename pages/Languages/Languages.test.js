...
describe(`Languages`, function() {
  ...
  describe(`/languages`, function() {
    ...
    it(`displays all public languages`, function() {
      ...
      const publicLanguages = this.languages.filter(language => language.permissions.public)
    ...
    it(`displays all private languages the user has permission to access (owner@digitallinguistics.io)`, function() {
      ...
      const ownerLanguages = this.languages.filter(language => hasAccess(`owner@digitallinguistics.io`, language))

      cy.visit(`/languages`)
      cy.setCookie(msAuthCookie, `owner@digitallinguistics.io`)
      cy.visit(`/languages`)
      cy.get(`.languages-table tbody`).children().should(`have.length`, ownerLanguages.length)
    ...
    it(`displays all private languages the user has permission to access (editor@digitallinguistics.io)`, function() {
      ...
      const editorLanguages = this.languages.filter(language => hasAccess(`editor@digitallinguistics.io`, language))

      cy.visit(`/languages`)
      cy.setCookie(msAuthCookie, `editor@digitallinguistics.io`)
      cy.visit(`/languages`)
      cy.get(`.languages-table tbody`).children().should(`have.length`, editorLanguages.length)
    ...
    it(`displays all private languages the user has permission to access (viewer@digitallinguistics.io)`, function() {
      ...
      const viewerLanguages = this.languages.filter(language => hasAccess(`viewer@digitallinguistics.io`, language))

      cy.visit(`/languages`)
      cy.setCookie(msAuthCookie, `viewer@digitallinguistics.io`)
      cy.visit(`/languages`)
      cy.get(`.languages-table tbody`).children().should(`have.length`, viewerLanguages.length)
